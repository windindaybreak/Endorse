...
public class ZuLin extends Fragment {
    ...
    EditText Et_item, Et_reason, Et_company, Et_account, Et_addtip;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = getActivity ().getLayoutInflater ().inflate ( R.layout.fragment_zu_lin,container,false );
    ...
    private void loadsave(){
        final SharedPreferences sharedPreferences = getActivity ().getSharedPreferences( "Zulin_save_data", MODE_PRIVATE );
    ...
    private void loaddata(){
        ...
        Et_reason.setText( data.get( 1 ) );
        datefrom.setText( data.get( 2 ).substring( 0, 8 ) );
        dateto.setText( data.get( 2 ).substring( 9 ) );
        Et_company.setText( data.get( 3 ) );
        Et_account.setText( data.get( 4 ) );
        Et_addtip.setText( data.get( 5 ) );
        System.out.println("租赁物品：" + data.get(0));
        System.out.println("租赁事由：" + data.get(1));
        System.out.println("租赁时间：" + data.get(2));
        System.out.println("租赁公司：" + data.get(3));
        System.out.println("预算余额：" + data.get(4));
        System.out.println("补充说明：" + data.get(5));
    }

    private void loadremain(){
        reply=con.CSQI("255", cookie, "000");
        List<String> data = new ArrayList<>();
        int p = reply.length() - 1, q = p;
        String temp;
        while (reply.charAt(p) == '#')
        ...
        dateto.setText( data.get( 2 ).substring( 9 ) );
        Et_company.setText( data.get( 3 ) );
        Et_account.setText( data.get( 5 ) );
        Et_addtip.setText( data.get( 4 ) );
        System.out.println("租赁物品：" + data.get(0));
        System.out.println("租赁事由：" + data.get(1));
        System.out.println("租赁时间：" + data.get(2));
        System.out.println("租赁公司：" + data.get(3));
        System.out.println("补充说明：" + data.get(4));
        System.out.println("预算余额：" + data.get(5));
    }
    ...
    private void setWidget() {
        ...
        Et_item = view.findViewById( R.id.Et租借物品 );
        Et_reason = view.findViewById( R.id.Et租借理由 );
        Et_company = view.findViewById( R.id.Et租借公司 );
        Et_account = view.findViewById( R.id.Et租借预算 );
        Et_addtip = view.findViewById( R.id.Et租借备注 );

        Btn_left = view.findViewById( R.id.Btn租赁撤销 );
        Btn_submit = view.findViewById( R.id.Btn租赁提交 );
        Btn_quick = view.findViewById( R.id.Btnzulin快速报销 );
        Btn_addaccount = view.findViewById( R.id.Btnzulin追加预算 );
        Btn_end = view.findViewById( R.id.Btnzulin结束行程 );

        btngroup1 = view.findViewById( R.id.Btngroup1_zulin );
        btngroup2 = view.findViewById( R.id.Btngroup2_zulin );

        editor = getActivity ().getSharedPreferences( "Zulin_save_data", MODE_PRIVATE ).edit();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (imagePath != null) {
            ...
            //con.CSQI( "406", cookie, new_name ); // 差旅快速报销
            if(con.CSQI("406", cookie, new_name).equals("200#")) // 差旅快速报销
            {
